...
// ─── If Block (supports optional return and optional else branch) ──────────
ifBlock
    : IF pyExpression COLON innerBodyStatement* (RETURN pyExpression)?
      (ELSE COLON innerBodyStatement* (RETURN pyExpression)?)?       #ifBlockDef
    ;
